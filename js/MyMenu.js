 ...
 */
MyInteractiveMarkerMenu = function(options) {
  var that = this;
  options = options || {};
 ...
 */
MyInteractiveMarkerMenu.prototype.show = function(control, event) {
 ...
 */
MyInteractiveMarkerMenu.prototype.hide = function(event) {
  if (event && event.preventDefault) {
    event.preventDefault();
  }
